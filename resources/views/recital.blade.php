    ...
    <div class="container pb-5 pt-3">
        <div class="row">
            <div class="col-sm d-flex align-items-center justify-content-center">
                <video poster="/images/17-recital-poster.png" src="/images/recital-25.mp4" type="video/mp4" controls="true" class="shadow rounded mb-2" style="max-width: 950px; width: 100%; height: auto;"></video>
            </div>
            <div class="col-sm">
